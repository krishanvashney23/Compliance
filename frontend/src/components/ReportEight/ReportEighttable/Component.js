        ...
        <div className='tabl '>
          <div className="table-responsive report2">
            <table className="table table-bordered text-center">
              <thead>
                <tr>
                  <th colspan="10" className="fixed-text">Fixed Text</th>
                </tr>
                <tr>
                  <th colspan="10" className="fixed-text">Fixed Text</th>
                </tr>
                <tr>
                  <th colspan="10" className="variable-text1">Fixed Text</th>
                </tr>

                <tr>
                  <th colspan="10" className="fixed-text"></th>
                </tr>
                <tr>
                  <th colspan="3" className="variable-text">Fixed Text</th>
                  <th colspan="7" className="fixed-text">Variable Text</th>
                </tr>
